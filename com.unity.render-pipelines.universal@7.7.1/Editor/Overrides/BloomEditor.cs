...
namespace UnityEditor.Rendering.Universal
{
    ...
    sealed class BloomEditor : VolumeComponentEditor
    {
        ...
        SerializedDataParameter m_SkipCounts;
        SerializedDataParameter m_BlurOffset;
        SerializedDataParameter m_MobileBloom;
        ...
        public override void OnEnable()
        {
            ...
            m_SkipCounts = Unpack(o.Find(x => x.skipCounts));
            m_BlurOffset = Unpack(o.Find(x => x.blurOffset));
            m_MobileBloom = Unpack(o.Find(x => x.mobileBloom));
        ...
        public override void OnInspectorGUI()
        {
            ...
            PropertyField(m_MobileBloom);
            PropertyField(m_BlurOffset);
            PropertyField(m_SkipCounts);
