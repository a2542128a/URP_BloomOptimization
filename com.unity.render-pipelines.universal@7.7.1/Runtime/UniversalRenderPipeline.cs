    ...
    public sealed partial class UniversalRenderPipeline : RenderPipeline
    {
        ...
        static void RenderCameraStack(ScriptableRenderContext context, Camera baseCamera)
        {
            ...
            for (int i = 0; i < cameraStack.Count; ++i)
            {
                ...
                if (currCameraData != null)
                {
                    ...
                    overlayCameraData.cameraTargetDescriptor = CreateRenderTextureDescriptor(currCamera,overlayCameraData.renderScale,
                        baseCameraData.isStereoEnabled,baseCameraData.isHdrEnabled,msaaSamples,Graphics.preserveFramebufferAlpha,false
                        );
        ...
        static void InitializeStackedCameraData(Camera baseCamera, UniversalAdditionalCameraData baseAdditionalCameraData, ref CameraData cameraData)
        {
            ...
            cameraData.cameraTargetDescriptor = CreateRenderTextureDescriptor(baseCamera, cameraData.renderScale,
                cameraData.isStereoEnabled, cameraData.isHdrEnabled, msaaSamples, needsAlphaChannel,false);
        }
