...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    public class PostProcessPass : ScriptableRenderPass
    {
        ...
        void SetupBloom(CommandBuffer cmd, int source, Material uberMaterial)
        {
            ...
            if (m_Bloom.mobileBloom.value)
                iterations -= m_Bloom.skipCounts.value;
            ...
            bloomMaterial.SetFloat(ShaderConstants._BloomBlurOffset, m_Bloom.blurOffset.value);
            ...
            // Downsample - Kawasa Blur pyramid
        ...
        static class ShaderConstants
        {
            ...
            public static readonly int _BloomBlurOffset    = Shader.PropertyToID("_Offset");
